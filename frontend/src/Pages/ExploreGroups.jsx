    ...
    >
      <div style={{ display:'flex', gap:14, alignItems:'flex-start' }}>
        ...
        <div style={{ flex:1, minWidth:0 }}>
          ...
          <p style={{ color:'rgba(255,255,255,0.35)', fontSize:12, margin:'0 0 12px', lineHeight:1.55,
    ...
    <div>
      ...
      {loading && allGroups.length === 0 ? (
        <div style={{ textAlign:'center', padding:'80px 0' }}>
          <div style={{ width:40, height:40, border:'3px solid rgba(99,102,241,0.2)', borderTopColor:'#818cf8', borderRadius:'50%', animation:'eg-spin 0.8s linear infinite', margin:'0 auto 16px' }} />
          <p style={{ color:'rgba(255,255,255,0.3)', fontSize:14 }}>Loading groups…</p>
        </div>
      ) : (
        <>
          {/* Suggested */}
